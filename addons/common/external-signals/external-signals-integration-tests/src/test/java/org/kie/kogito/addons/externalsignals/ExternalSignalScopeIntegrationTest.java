...
public class ExternalSignalScopeIntegrationTest {
    ...
    /**
     * Test 1: testExternalSignalScopeWithHandler
     * 
    ...
    public void testExternalSignalScopeWithHandler() {
        ...
        when(workItem.getProcessInstanceId()).thenReturn("process-123");
        when(workItem.getProcessInstanceStringId()).thenReturn("process-123");
        ...
        assertThat(event.getSourceProcessInstanceId()).isEqualTo("process-123");
    ...
    /**
     * Test 2: testExternalSignalScopeWithConfiguration
     * 
    ...
    public void testExternalSignalScopeWithConfiguration() {
        ...
        when(workItem.getProcessInstanceId()).thenReturn("process-456");
        when(workItem.getProcessInstanceStringId()).thenReturn("process-456");
    ...
    /**
     * Test 3: testExternalSignalScopeWithMetadata
     * 
    ...
    public void testExternalSignalScopeWithMetadata() {
        ...
        when(workItem.getProcessInstanceId()).thenReturn("process-789");
        when(workItem.getProcessInstanceStringId()).thenReturn("process-789");
        ...
        assertThat(event.getSourceProcessInstanceId()).isEqualTo("process-789");
        assertThat(event.getCorrelationId()).isEqualTo("work-item-3");

        // Verify all metadata fields
        Map<String, Object> metadata = event.getMetadata();
        assertThat(metadata).containsEntry("targetProcessInstanceId", "target-process-123");
    ...
    /**
     * Test 4: testExternalSignalScopeWithoutHandler
     * 
    ...
    /**
     * Test 5: testExternalSignalScopeMultipleSignals
     * 
    ...
    public void testExternalSignalScopeMultipleSignals() {
        ...
        for (int i = 0; i < signalNames.size(); i++) {
            ...
            when(workItem.getProcessInstanceId()).thenReturn("process-" + (i + 1));
            when(workItem.getProcessInstanceStringId()).thenReturn("process-" + (i + 1));
        ...
        for (int i = 0; i < signalNames.size(); i++) {
            ...
            assertThat(event.getSourceProcessInstanceId()).isEqualTo("process-" + (i + 1));
        }
    }

    /**
     * Test 6: testExternalSignalScopeWithEmptySignalName
     * 
    ...
    /**
     * Test 7: testExternalSignalScopeWithInvalidSignalType
     * 
    ...
    /**
     * Test 8: testExternalSignalScopeWithDispatcherException
     * 
    ...
    public void testExternalSignalScopeWithDispatcherException() {
        ...
        when(workItem.getProcessInstanceId()).thenReturn("process-777");
        when(workItem.getProcessInstanceStringId()).thenReturn("process-777");
    ...
    /**
     * Test 9: testExternalSignalScopeEventStructure
     * 
    ...
    public void testExternalSignalScopeEventStructure() {
        ...
        when(workItem.getProcessInstanceId()).thenReturn("process-888");
        when(workItem.getProcessInstanceStringId()).thenReturn("process-888");
        ...
        assertThat(event.getSource()).hasToString("kogito://process/process-888");
        ...
        assertThat(event.getSourceProcessInstanceId()).isEqualTo("process-888");
