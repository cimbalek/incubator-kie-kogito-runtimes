 ...
 * 
 * <p>
 * <b>Phase 1 Behavior:</b>
 * </p>
 * <p>
 * In Phase 1, this handler operates in fire-and-forget mode. The signal is dispatched
 * and the work item is immediately completed without waiting for a response. Correlation
 * support for request-response patterns will be added in Phase 2.
 * </p>
 * 
...
public class ExternalSignalWorkItemHandler extends DefaultKogitoWorkItemHandler {
    ...
    /**
     * Creates a new handler with default configuration.
     */
    ...
    public Optional<WorkItemTransition> activateWorkItemHandler(
        ...
        try {
            ...
            if (workItem.getNodeInstance() != null) {
                ...
                event.addMetadata("nodeId", String.valueOf(workItem.getNodeInstance().getNodeId()));
            }
            ...
            // Phase 1: Complete work item immediately (fire-and-forget)
            // Phase 2 will add correlation support for request-response patterns
